...
<template>
    <el-form ref="ruleFormRef" :model="registerForm" style="max-width: 600px" :rules="rules" label-width="auto"
        class="demo-ruleForm">
        ...
        <el-form-item>
            <el-button type="success" @click="submitForm(ruleFormRef)">注册
            </el-button>
            <el-button type="primary" @click="jumpToLogin">登录
            </el-button>
